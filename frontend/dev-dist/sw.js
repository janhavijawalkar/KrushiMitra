...
define(['./workbox-caf3a6a6'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/api\/weather/, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/\/api\/(history|recommend|predict)/, new workbox.NetworkFirst({
